...
return {
  ...
  colors = {
    ...
    split = catppuccin_colors.surface0,
    tab_bar = {
      background = catppuccin_colors.crust,
    },
  },
  window_frame = {
  ...
  keys = {
    -- Open/close tabs
    { mods = "ALT", key = "w", action = wezterm.action { SpawnTab = "CurrentPaneDomain" } },
    { mods = "ALT", key = "Q", action = wezterm.action { CloseCurrentTab = { confirm = true } } },
    { mods = "ALT", key = "q", action = wezterm.action { CloseCurrentPane = { confirm = true } } },
    -- Window movement
    ...
    { mods = "ALT|SHIFT", key = "h", action = wezterm.action.ActivatePaneDirection "Left" },
    { mods = "ALT|SHIFT", key = "j", action = wezterm.action.ActivatePaneDirection "Down" },
    { mods = "ALT|SHIFT", key = "k", action = wezterm.action.ActivatePaneDirection "Up" },
    { mods = "ALT|SHIFT", key = "l", action = wezterm.action.ActivatePaneDirection "Right" },
    -- Resize
    { mods = "CTRL|ALT", key = "LeftArrow", action = wezterm.action.AdjustPaneSize { "Left", 1 } },
    { mods = "CTRL|ALT", key = "DownArrow", action = wezterm.action.AdjustPaneSize { "Down", 1 } },
    { mods = "CTRL|ALT", key = "RightArrow", action = wezterm.action.AdjustPaneSize { "Right", 1 } },
    { mods = "CTRL|ALT", key = "UpArrow", action = wezterm.action.AdjustPaneSize { "Up", 1 } },
    -- Move to tab
